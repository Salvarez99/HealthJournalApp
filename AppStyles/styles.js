...
// InnerContainer >> smaller  container 
...
export const PageTitle = styled.Text({
    ...
    fontSize: props => props.welcome ? '35px' : '30px', /* if props.welcome is ture font size : 35 else 30px*/
    textAlign: 'center',
    fontWeight: 'bold',
...
// StyledInputLabel >> InputLabel  only for signup. 
...
// ButtonText - pass properties. >> either  LoginTextInButton or GoogleTextInButton
