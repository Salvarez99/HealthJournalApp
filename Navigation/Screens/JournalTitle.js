    ...
    switch(araytype) {
      ...
      case 'TestsAndLabWorks':
        return(
          <>
          <View sytle={styles.entryContainer}>
          <Text style={styles.entryTitle}>Test & Labwork Name:  {entry.name}</Text>
          <Text syle={styles.entryDate}>
  ...
  return (
    ...
    <View style={styles.container}>
     {/*call const checkpassedinfo to check wehther array is undefined or not. */}
       ...
       <Text style={styles.mainIdContainer}>Journal {arryOfAppointmentInfo.id.toString()}</Text>
        {/* Render Symptoms */}
        ...
        <View style={styles.innerContainer}>
          {renderIfExists(arryOfAppointmentInfo.TestsAndLabWorks, 'TestsAndLabWorks')}
        </View>
